...
public class Client implements ActionListener
{
    ...
    */
    ...
    public void actionPerformed(ActionEvent ae)
    {
       ...
       dout.writeUTF(out);
       //When send button has been clicked make the text filed empty
       text.setText("");
       f.repaint();
       f.invalidate();
       f.validate();   
    ...
    public static JPanel formatLabel(String out)
    {
        ...
        /*
        The "width:150px" style attribute in the HTML code is used to specify
        the width of the text content inside the <p> tag. This allows you to
        control the width of the text block displayed in the JLabel.
        */
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            //here socket  have to be created 
            // on which port the server is running : 6001
            //Hosting of the server local host the address of this is 127.0.0.1
